import { createContext, createElement, Component, forwardRef } from 'react';
...
function subscribe(name, fn, eventStore) {
  ...
  // mutate eventStore
  var idx = eventStore[name].push(fn) - 1;
  return function () {
...
function combineReducers(reducers) {
  ...
  return function combination() {
    ...
    if (!action || typeof action.type !== "string") {
      console.error("All actions must contain a type attribute, eg: { type: String, ... }, we will ignore your action", action, state);
      return state;
    }
...
var ReactTrio = function (_React$Component) {
  ...
  function ReactTrio(props) {
    ...
    _this.listen = function (eventName, cb) {
      return subscribe(eventName, cb, _this.emitter);
    };
...
var withCore = function withCore(Component$$1) {
  var selectProps = Component$$1.stateToProps;
  ...
  return forwardRef(function (props, ref) {
    return createElement(
      ...
      null,
      function (data) {
        return createElement(Component$$1, _extends$1({}, props, extraProps(data), {
          ref: ref,
          emit: data.emit,
          listen: data.listen
        }));
...
export { combineReducers, subscribe, withCore, Connect, ReactTrio as Provider };
